...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            <!-- Admin Slidenav -->
            <%@include file="components/staffSlideNavComponent.jsp" %>
                                ...
                                <div class="modal fade" id="changeProfileBtn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="StaffInforController" method="POST" id="update-form">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div id="change-psw-error" class="form-outline mt-3 fst-italic text-center"
                                                 style="color: red; font-size: 18px;"></div>
                                            <form action="StaffInforController" method="POST" id="change-psw-form">
                                                <div class="modal-body">
                                                    <!-- Old password -->
                                                    <div class="form-outline mb-3">
