    ...
    <div class="container-menu-desktop">
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                <div class="left-top-bar">
                    Free shipping for standard order over 200000 dong
                </div>
                <div class="right-top-bar flex-w h-full">
                    <a class="text-decoration-none flex-c-m trans-04 p-lr-25" href="#"><i class="bi bi-phone me-2"></i>+84 0392417166</a>
                    <a class="text-decoration-none flex-c-m trans-04 p-lr-25" href="#"><i class="bi bi-envelope me-2"></i>nampqhe173479@fpt.edu.vn</a>
                    <a href="https://www.facebook.com/profile.php?id=100028327173617" class="flex-c-m trans-04 p-lr-25"><i class="bi bi-facebook"></i></a>
                    <a href="#" class="flex-c-m trans-04 p-lr-25"><i class="bi bi-twitter"></i></a>
                    <a href="https://www.instagram.com/nammphh_/?hl=en" class="flex-c-m trans-04 p-lr-25"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <img src="./img/logo-search-grid-1x.jpg" alt="IMG-LOGO">
            </a>
...
<div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
        <a href="${homeUrl}"><img src="./img/logo-search-grid-1x.jpg" alt="IMG-LOGO"></a>
    </div>
