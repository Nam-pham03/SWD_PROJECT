                        ...
                        <div class="col mb-5 product-all">
                            <div class="card h-100">
                                ...
                                <c:url var="linkImg" value="PlantDetailController">
                                    <c:param name="pid" value="${LPS.product_id}"></c:param>
                                </c:url>
                                <a href="${linkImg}" class="img-h-350"><img src="${LPS.img}" alt="Plant IMG" /></a>
                                <!-- Product details-->
...
<!--                                        <div class="category ms-3 mt-3 text-start">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <a onclick="addToCartAsync(${LPS.product_id})" class="btn btn-outline-dark mt-auto w-50"><i
