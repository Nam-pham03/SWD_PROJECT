...
<footer class="py-3 text-black" style="background-color: aliceblue;">
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <img class="logo" src="img/logo-search-grid-1x.jpg" alt="Shop Logo">
            ...
            <div id="quick-link" class="col-lg-6">
                ...
                <table>
                    <tr>
                        <td>
                            <ul class="quick-ul">
                                <li type="square"><a href="#">Shop Books</a></li>
                                <li type="square"><a href="#">Shop Plants</a></li>
                                <li type="square"><a href="#">Manga</a></li>
                                <li type="square"><a href="#">Funeral</a></li>
                            </ul>
                        </td>
                        <td>
                            <ul class="quick-ul">
                                <li type="square"><a href="#">Book</a></li>
            ...
            <div class="col-lg-3 mailing-address">
                ...
                <div class="default-cursor"><i class="bi bi-building"></i> FPT University
                </div>
                <div class="default-cursor"><i class="bi bi-phone"></i> +84 392417166</div>
                <div class="default-cursor"><i class="bi bi-envelope"></i> nampqhe173479@fpt.edu.vn</div>
            </div>
        </div>
        <p class="copyright cl6 txt-center">
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" class="text-decoration-none">Nam Pham</a> &amp; distributed by <a href="https://themewagon.com" target="_blank" class="text-decoration-none">Nam Pham</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
    </div>
</footer>
