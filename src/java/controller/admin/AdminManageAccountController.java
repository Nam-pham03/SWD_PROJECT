 ...
 * @author PCASUS
 */
@WebServlet(name = "AdminManageAccountController", urlPatterns = {"/AdminManageAccountController"})
public class AdminManageAccountController extends HttpServlet {

    private final AccountService accountService;
    private final CustomerService customerService;

    public AdminManageAccountController() {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("manageCustomerAccountPage.jsp").forward(request, response);
        }
    }
