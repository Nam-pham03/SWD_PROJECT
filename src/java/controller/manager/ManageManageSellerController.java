 ...
 * @author PCASUS
 */
@WebServlet(name = "ManageManageSellerController", urlPatterns = {"/ManageManageSellerController"})
public class ManageManageSellerController extends HttpServlet {

    private final AccountService accountService;
    private final StaffService staffService;

    public ManageManageSellerController() {
